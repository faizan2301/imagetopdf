...
import 'package:imagetopdf/logic/logic.dart';
...
class _ExitScreenState extends State<ExitScreen> {
  ...
  final dfs=DocumentFileSavePlus();
                ...
                ListTile(
                  onTap: ()async{
                    if(controller.text.isNotEmpty){
                      await dfs.saveFile(data.pdf.value!.readAsBytesSync(), "${controller.text}.pdf", "appliation/pdf");
  ...
  Future<void> shareFile(String path) async {
    ...
    await dfs.saveFile(data.pdf.value!.readAsBytesSync(), "example.pdf", "appliation/pdf");
